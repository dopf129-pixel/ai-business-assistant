...
class Summary:
    ...
    def calculate(self, date_from, date_to, products):
        ...
        return {"error": False, "status": "PERIOD_PROFIT_SUMMARY_READY", "date_from": date_from, "date_to": date_to, "revenue": 1000, "net_accrual": 800, "product_cost": 300, "tax": 60, "profit": profit, "margin_percent": profit / 10, "products": [], "returns_included": False, "advertising_included": False, "storage_included": False, "profit_scope": "V1"}


def test_query_returns_user_text():
