...
GitHub Actions push verification run #401 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #401, exact SHA-bound main verification with canonical `test-report.json` artifact.
