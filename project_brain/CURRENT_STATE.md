...
GitHub Actions push verification run #305 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #305, exact SHA-bound main verification with canonical `test-report.json` artifact.
