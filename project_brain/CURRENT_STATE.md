...
GitHub Actions push verification run #243 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #243, exact SHA-bound main verification with canonical `test-report.json` artifact.
