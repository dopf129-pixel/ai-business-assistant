...
GitHub Actions push verification run #380 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #380, exact SHA-bound main verification with canonical `test-report.json` artifact.
