...
GitHub Actions push verification run #374 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #374, exact SHA-bound main verification with canonical `test-report.json` artifact.
