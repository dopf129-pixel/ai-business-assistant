...
GitHub Actions push verification run #409 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #409, exact SHA-bound main verification with canonical `test-report.json` artifact.
