...
GitHub Actions push verification run #394 completed successfully for this exact main SHA.
...
Verification source:
GitHub Actions push run #394, exact SHA-bound main verification with canonical `test-report.json` artifact.
